var words = {
	muy: 'totemo', muchisimo: 'taihen', muchos: 'takusan', juntos: 'issho ni', solo: 'hitori de',
	unoMismo: 'jibun de', quiza: 'tabun', casiTodos: 'daitai', cerca: 'chikaku', lejos: 'tooku', hacePoco: 'sakki'
};
