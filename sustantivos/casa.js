var words = {tele:'terebi',radio:'rajio',maquina:'kikai',nevera:'reizooko',sofa:'sofa',silla:'isu',muebles:'kagu',
			escritorio:'tsukue',cama:'beddo',basura:'gomi',telefono:'denwa',puerta:'doa',habitacion:'heya',escaleras:'kaidan',
			entrada:'iriguchi',salida:'deguchi',jardin:'niwa',ventana:'mado'};

vvar selectedIndex = 0;
var keys = [];
var display = false;
var japo = false;
