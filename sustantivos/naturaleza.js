var words = {agua:'mizu',fuego:'hi',viento:'kaze',piedra:'ishi',madera:'ki',oro:'kin',
			planta:'shokubutsu',flor:'hana',arbol:'ki',cerezo:'sakura',rosa:'bara',mar:'umi',playa:'hamabe'};
